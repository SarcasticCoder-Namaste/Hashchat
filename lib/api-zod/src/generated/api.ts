...
export const getForYouFeedQueryOffsetDefault = 0;

export const GetForYouFeedQueryParams = zod.object({
  limit: zod.coerce.number().default(getForYouFeedQueryLimitDefault),
  offset: zod.coerce.number().default(getForYouFeedQueryOffsetDefault),
});

export const getForYouFeedResponseItemsItemRoomOneLastMessageOneAudioWaveformItemMin = 0;
export const getForYouFeedResponseItemsItemRoomOneLastMessageOneAudioWaveformItemMax = 100;

export const GetForYouFeedResponse = zod.object({
  items: zod.array(
    zod.object({
                  ...
                  audioWaveform: zod
                    .array(
                      zod
                        .number()
                        .min(
                          getForYouFeedResponseItemsItemRoomOneLastMessageOneAudioWaveformItemMin,
                        )
                        .max(
                          getForYouFeedResponseItemsItemRoomOneLastMessageOneAudioWaveformItemMax,
                        ),
                    )
                    .nullish(),
  ...
  total: zod.number(),
  signals: zod.object({
    ownHashtags: zod.number(),
    followedHashtags: zod.number(),
    following: zod.number(),
    recentReactions: zod.number(),
    recentReplies: zod.number(),
    recentRoomVisits: zod.number(),
  }),
});
...
export const muteConversationResponseLastMessageOneAudioWaveformItemMin = 0;
export const muteConversationResponseLastMessageOneAudioWaveformItemMax = 100;
      ...
      zod.object({
        ...
        audioWaveform: zod
          .array(
            zod
              .number()
              .min(muteConversationResponseLastMessageOneAudioWaveformItemMin)
              .max(muteConversationResponseLastMessageOneAudioWaveformItemMax),
          )
          .nullish(),
        audioTranscript: zod.string().nullish(),
        reactions: zod.array(
 ...
 */
export const UnmuteConversationParams = zod.object({
  id: zod.coerce.number(),
});

export const unmuteConversationResponseLastMessageOneAudioWaveformItemMin = 0;
export const unmuteConversationResponseLastMessageOneAudioWaveformItemMax = 100;

export const UnmuteConversationResponse = zod.object({
  id: zod.number(),
  kind: zod.enum(["direct", "group"]),
  title: zod.string().nullish(),
  creatorId: zod.string().nullish(),
      ...
      zod.object({
        ...
        audioWaveform: zod
          .array(
            zod
              .number()
              .min(unmuteConversationResponseLastMessageOneAudioWaveformItemMin)
              .max(
                unmuteConversationResponseLastMessageOneAudioWaveformItemMax,
              ),
          )
          .nullish(),
        audioTranscript: zod.string().nullish(),
